...
export interface BinaryHelper {
     ...
     */
    readASCIIArray: (data: Uint8Array, position: number, length: number) => string[];
    /**
...
export type FontCmapSubTable = FontCmapSubTable0 | FontCmapSubTable4 | FontCmapSubTable6 | FontCmapSubTable12;
...
export type FontCblcEntry = [fgI: number, lgI: number, imF: number, oarr: number[]];
...
export type FontOs2 = FontOs2Version0 | FontOs2Version1 | FontOs2Version2 | FontOs2Version3 | FontOs2Version4 | FontOs2Version5;
...
export interface FontTabProcessor<T> {
     ...
     */
    parseTab: (data: Uint8Array, offset: number, length: number, obj: FontParseState) => T;
}
...
export interface Util {
     ...
     */
    shapeToPath: (font: FontObject, shape: GlyphInfo[], clr?: VectorPathCommand) => VectorPath;
